...
public class CrowdConstant {
    ...
    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_USER = "这个账号已经被使用";
    public static final String MESSAGE_LOGIN_ACCESS_FORBIDEN = "请登录后访问";
    public static final String MESSAGE_ACCESS_DENIED = "您没有该权限";
    ...
    public static final String MESSAGE_CODE_NOT_EXISTS = "验证码已过期，请检查手机号是否正确" ;
    ...
    public static final String ATTR_NAME_TEMPLE_PROJECT = "temProject";

    public static final String REDIS_CODE_PREFIX = "REDIS_CODE_PREFIX_";


    public static final String MESSAGE_TEMPLE_PROJECT_MISSING = "临时存储的project对象为空";
